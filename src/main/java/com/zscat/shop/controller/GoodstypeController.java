...
public class GoodstypeController {
	...
	@GetMapping()
	@RequiresPermissions("shop:goodstype:goodstype")
	String Goodstype(){
	    return "shop/goodstype/goodstype";
	}
	...
	@ResponseBody
	@RequiresPermissions("shop:goodstype:batchRemove")
