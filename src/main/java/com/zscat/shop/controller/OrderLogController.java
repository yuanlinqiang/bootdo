...
public class OrderLogController {
	...
	@GetMapping()
	@RequiresPermissions("shop:orderLog:orderLog")
	String OrderLog(){
	    return "shop/orderLog/orderLog";
	}
	...
	@ResponseBody
	@RequiresPermissions("shop:orderLog:batchRemove")
